...
sleep 2
echo $i"Jangan Lupa Follow Instagramku:@ultimate_007"_
sleep 1
echo $i"Jangan Disalah Gunakan"
sleep 1
echo $i"Silakan Gunakan Script Saya😊"
sleep 2
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo $i" |"$cy"     INDONESIA DARK TERMUX ASSOCIATE"$i"          |"
echo $i" |"$me"─────────────────────────────────────────────"$i" |"
echo $i" |"$pu" AUTHOR :"$ku" RONALD HENDRAWAN  [FR13ND8]"$i"    |"
echo $i" |"$pu" INSTAGRAM :"$ku" @ultimate_007"$i"               |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.P3RC1L] [MR.Naldd[MR.B]"$i"|"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [AldykaPrygh]"$i"  |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 082277001533"$i"         |"
echo $i" |"$pu" Kontak Gmail :"$ku"ronaldhendrawann@gmail.com"$i"|"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
sleep 2
echo $i"────────────────────────────────    ─────"
...
sleep 2
echo $ku"WhatsApp :"$i" 082277001533"
echo $ku"Instagram :"$i" @ultimate_007_"
sleep 2
